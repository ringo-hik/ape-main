...
export class WelcomeViewProvider {
   ...
   */
  private static generateHtml(webview: vscode.Webview, extensionUri: vscode.Uri): string {
    ...
    const apeIconUri = webview.asWebviewUri(
      vscode.Uri.joinPath(extensionUri, 'media', 'icons', 'ape.svg')
    );
