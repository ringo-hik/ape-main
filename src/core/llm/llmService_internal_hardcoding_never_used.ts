...
const MODEL_LLAMA_MAVERICK = 'meta-llama/llama-4-maverick-17b-128e-instruct' as LLMModel;
...
export class LLMService implements vscode.Disposable {
  private _endpoint: string = MAVERICK_ENDPOINT;
  private _connectionType: ConnectionType = ConnectionType.HTTP;
  ...
  private _activeModel: LLMModel = DEFAULT_MODEL;
   ...
   */
  public async setActiveModel(model: string): Promise<boolean> {
