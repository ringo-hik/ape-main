...
class LLMService {
    ...
    async _sendHttpRequest(messages, options) {
        ...
        try {
            const response = await axios_1.default.post(this._endpoint, request, { headers });
    ...
    async _streamHttpResponse(messages, streamCallback, options) {
        ...
        try {
            ...
            let chunkCount = 0;
            let accumulatedText = '';
            const response = await axios_1.default.post(this._endpoint, request, {
                responseType: 'stream',
    ...
    _ensureWebSocketConnection() {
        ...
        if (!this._wsConnection || this._wsConnection.readyState !== WS_OPEN) {
            ...
            try {
                ...
                this._wsConnection = new ws_1.WebSocket(this._endpoint);
