...
exports.TabCompletionProvider = void 0;
...
class TabCompletionProvider {
    ...
    async provideCodeCompletions(document, position, linePrefix) {
        ...
        try {
            ...
            // 이전 줄과 현재 줄 추출
            const precedingLines = document.getText(new vscode.Range(new vscode.Position(Math.max(0, position.line - 10), 0), position));
            // 파일 유형 확인
...
exports.TabCompletionProvider = TabCompletionProvider;
//# sourceMappingURL=tabCompletionProvider.js.map