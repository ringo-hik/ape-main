...
exports.SmartPromptingService = exports.SmartPromptingMode = void 0;
...
(function (SmartPromptingMode) {
    ...
    SmartPromptingMode["Expert"] = "expert";
    SmartPromptingMode["Custom"] = "custom";
    SmartPromptingMode["Creative"] = "creative";
    SmartPromptingMode["Friendly"] = "friendly"; // 친구 모드 - 캐주얼 대화
})(SmartPromptingMode || (exports.SmartPromptingMode = SmartPromptingMode = {}));
/**
 * 스마트 프롬프팅 서비스
 *
...
제안하는 변경 사항은 기존 기능을 손상시키지 않으면서 코드베이스의 품질을 향상시키는 데 중점을 두어야 합니다. 대규모 변경이 필요한 경우, 점진적인 리팩토링 접근 방식을 제안해 주세요.`;
     ...
     * @returns 증강된 메시지
     */
    applyCreativePrompting(message) {
...
자유롭고 창의적인 사고를 바탕으로, 구체적이고 실용적인 아이디어를 균형 있게 제시해 주세요. 혁신적이면서도 현실적으로 구현 가능한 제안에 초점을 맞춰주세요.`;
     ...
     * @returns 증강된 메시지
     */
    applyFriendlyPrompting(message) {
...
exports.SmartPromptingService = SmartPromptingService;
//# sourceMappingURL=smartPromptingService.js.map