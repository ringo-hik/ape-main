...
exports.StandardChatViewProvider = void 0;
 ...
 */
class StandardChatViewProvider {
    _context;
    _llmService;
    _memoryService;
    _commandManager;
    ...
    async resolveWebviewView(webviewView, _context, _token) {
        ...
        // Code service handlers 등록 임시 비활성화
        console.log('CodeService handlers registration temporarily disabled for testing');
        // 나중에 활성화
        // try {
    ...
    _getHtmlForWebview(webview) {
        ...
        // 코드 아이콘 CSS는 불필요한 오류를 방지하기 위해 생략
    ...
    <head>
      ...
      <meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src ${webview.cspSource} 'unsafe-inline'; font-src ${webview.cspSource} data:; img-src ${webview.cspSource} https: data:; script-src ${webview.cspSource} 'nonce-${nonce}' 'unsafe-inline' 'unsafe-eval'; connect-src ${webview.cspSource} https: data:;">
...
exports.StandardChatViewProvider = StandardChatViewProvider;
//# sourceMappingURL=standardChatViewProvider.js.map