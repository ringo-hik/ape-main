...
class ChatViewProvider {
    ...
    constructor(_context, _llmService, _memoryService, _commandManager, _modelManager) {
        ...
        this._smartPromptingService = new smartPromptingService_1.SmartPromptingService(_context, _llmService);
        // 상태 변경 리스너 등록
     ...
     * 메시지 컨텍스트 포함/제외 토글
     */
    async _toggleMessageContext(messageId) {
        try {
            // 메시지 찾기
    ...
    _getHtmlForWebview(webview) {
        ...
        const modernStylesUri = webview.asWebviewUri(vscode.Uri.joinPath(this._context.extensionUri, 'media', 'chat-ape.css'));
