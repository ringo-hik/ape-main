...
exports.generateHtmlHeader = generateHtmlHeader;
exports.generateChatUiHtml = generateChatUiHtml;
 ...
 * @returns 웹뷰 HTML 헤더
 */
function generateHtmlHeader(webview, extensionUri, nonce) {
    // 리소스 경로 가져오기
    const modernStylesUri = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, 'media', 'chat-ape.css'));
 ...
 */
function generateChatUiHtml(webview, extensionUri, minimal = false) {
...
//# sourceMappingURL=_getHtmlForWebview.js.map