...
async function initializeServices(context) {
    ...
    const treeDataProvider = new apeTreeDataProvider_1.ApeTreeDataProvider(context, llmService, memoryService, undefined, // todoService
...
function registerComponents(context, services) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('ape.insertCodeToEditor', (options) => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('ape.git.resolveConflict', async () => {
